                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        <tr><td><a href="viewFiles.jsp?uni=<%=university%>&dept=<%=dept%>&category=<%=cat.getCategory()%>" style="text-decoration: none;"><%=cat.getCategory()%></a></td></tr>
                                            <% }%>
                                </tbody>
                            </table>
                                <a class="btn btn-default" href="viewRepository2.jsp?uni=<%=university%>">Back</a>
                        </div>
                    </div>
                </div>
            </div>
