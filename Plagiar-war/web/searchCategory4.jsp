            ...
            <div class="row" id="contentRow">
                ...
                <div class="col-md-10 col-sm-10" id="contentBody">
                    <%
                        ...
                        System.out.println(uni + dept + category);
                        List<FilesPlagiar> searchResult = plagiarRemote.searchCategory(uni, dept, category);
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered" id="search">
                                ...
                                <tbody>
                                    ...
                                    %><tr>
                                        <td><a href="FileDownload.jsp?fileLocation=<%=filesPlagiar.getFilelocation()%>&filename=<%=filesPlagiar.getFilename()%>" style="text-decoration: none;"><%=filesPlagiar.getFilename()%></a></td>
                            ...
                            <a class="btn btn-default" href="searchCategory3.jsp?uni=<%=uni%>&department=<%=dept%>">Back</a><br><br>
                        </div>
                            </div>
                        </div>
                    </div>
