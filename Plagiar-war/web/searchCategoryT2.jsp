                ...
                <div class="col-md-10 col-sm-10" id="contentBody">
                    ...
                    <div class="panel-default">
                        <div class="panel-body">
                            <h3>Search</h3>
                            <form action="searchCategoryT3.jsp?uni=<%=university%>" method="post">
                            ...
                            Select Department: <select name="department" class="form-control" style="width:300px;">
                                ...
                                <a class="btn btn-default" href="searchCategoryT.jsp">Back</a> <button type="submit" class="btn btn-default">Next</button>
                        </form>
